...
class HomePageTest(TestCase):
    ...
    def test_home_page_returns_correct_html(self):
        ...
        self.assertTrue(response.content.startswith(b'<html>'))# content:html send to user
        self.assertIn(b'<title>Django</title>',response.content)
        self.assertTrue(response.content.endswith(b'</html>'))# content:html send to user
